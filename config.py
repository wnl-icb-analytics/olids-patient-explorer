...
DB_OBSERVATIONS = "MODELLING.OLIDS_OBSERVATIONS"
...
TABLE_PRACTITIONER_IN_ROLE = f"{DB_STAGING}.STG_OLIDS_PRACTITIONER_IN_ROLE"
...
# Currently empty: source person_id is NULL pending upstream backfill
TABLE_DIAGNOSTIC_ORDER = f"{DB_STAGING}.STG_OLIDS_DIAGNOSTIC_ORDER"
...
# Maximum encounter groups rendered on the encounters page
MAX_ENCOUNTER_GROUPS = 100
